...
angular.module('dockerui.services', ['ngResource'])
    ...
    .factory('Settings', function (DOCKER_ENDPOINT, DOCKER_PORT, DOCKER_API_VERSION, UI_VERSION,$location) {
        'use strict';
        var url = $location.absUrl();
        if($location.url().indexOf('ip') > -1){    
            var loc= $location.url().split('=')[1];
            DOCKER_ENDPOINT = "http://"+loc+":"; 
            DOCKER_PORT = "4243";
        } 
