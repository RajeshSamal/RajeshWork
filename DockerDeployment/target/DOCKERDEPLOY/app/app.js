angular.module('dockerui', ['dockerui.templates', 'ngRoute', 'dockerui.services', 'dockerui.filters', 'masthead', 'footer', 'dashboard', 'container', 'containers', 'containersNetwork', 'images', 'image', 'startContainer', 'sidebar', 'info', 'builder', 'containerLogs', 'containerTop','seturl'])
    .config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider.when('/seturl', {
            templateUrl: 'app/components/seturl/seturl.html',
